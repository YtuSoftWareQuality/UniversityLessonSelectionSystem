...
namespace UniversityLessonSelectionSystem.Tests.Tests
{
    internal class AccessPolicyAuthorizationServiceTests
    {
        ...
        [Test]
        public void Constructor_ThrowsArgumentNullException_WhenClockIsNull()
        {
            // Arrange & Act & Assert
            Assert.Throws<ArgumentNullException>(() =>
                new AccessPolicyAuthorizationService(null, _logger, _repo));
        }
        ...
        public void Constructor_ThrowsArgumentNullException_WhenLoggerIsNull()
        {
            // Arrange & Act & Assert
            Assert.Throws<ArgumentNullException>(() =>
                new AccessPolicyAuthorizationService(_clock, null, _repo));
        }
        ...
        public void Constructor_ThrowsArgumentNullException_WhenRepoIsNull()
        {
            // Arrange & Act & Assert
            Assert.Throws<ArgumentNullException>(() =>
                new AccessPolicyAuthorizationService(_clock, _logger, null));
        }
        ...
        public void Authorize_ThrowsArgumentNullException_WhenRequestIsNull()
        {
            ...
            _service = new AccessPolicyAuthorizationService(_clock, _logger, _repo);
        ...
        public void Authorize_ReturnsDeny_WhenRoleNotAllowed()
        {
            ...
            // Assert
            Assert.AreEqual(AccessOutcome.Deny, result.Outcome);
            Assert.AreEqual("Role not permitted.", result.Reason);
        }
        ...
        public void Authorize_ReturnsDeny_WhenFinalsLocked_EditTranscript()
        {
            ...
            // Assert
            Assert.AreEqual(AccessOutcome.Deny, result.Outcome);
            Assert.AreEqual("Operation locked during Finals/Closed.", result.Reason);
        }
        ...
        public void Authorize_ReturnsDeny_WhenContextMismatch_NoBreakGlass()
        {
            ...
            // Assert
            Assert.AreEqual(AccessOutcome.Deny, result.Outcome);
            Assert.AreEqual("Context mismatch.", result.Reason);
        }
        ...
        public void Authorize_ReturnsConditional_WhenContextMismatch_WithBreakGlass()
        {
            ...
            // Assert
            Assert.AreEqual(AccessOutcome.Conditional, result.Outcome);
            Assert.AreEqual("Break-glass required.", result.Reason); 
        ...
        public void Authorize_ReturnsDeny_WhenFerpaViolation_ViewPII_WrongRole()
        {
            ...
            // Assert
            Assert.AreEqual(AccessOutcome.Deny, result.Outcome);
            Assert.AreEqual("FERPA privacy constraint.", result.Reason);
        }
        ...
        public void Authorize_ReturnsConditional_WhenFerpaViolation_WithBreakGlass()
        {
            ...
            Assert.AreEqual(AccessOutcome.Allow, result.Outcome);
        }
        ...
        public void Authorize_ReturnsThrottle_WhenAfterHours_NoBreakGlass()
        {
            ...
            // Assert
            Assert.AreEqual(AccessOutcome.Throttle, result.Outcome);
            Assert.AreEqual("After-hours restriction.", result.Reason);
        ...
        public void Authorize_ReturnsConditional_WhenAfterHours_WithBreakGlass()
        {
            ...
            // Assert
            Assert.AreEqual(AccessOutcome.Conditional, result.Outcome);
            Assert.AreEqual("After-hours; break-glass allowed.", result.Reason);
            Assert.That(result.Obligations, Contains.Item(Obligation.AuditLog));
        }
        ...
        [TestCase(Role.Advisor, AccessContext.AdviseeRecord, true)]
